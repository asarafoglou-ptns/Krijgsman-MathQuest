...
setwd("/Users/brunykrijgsman/Documents/Documenten - MacBook Air van Bruny/Master PSY/Programming the Next Step")
rm(list = ls())
...
devtools::create('MathQuest')

# set working directory to *inside* your R package
setwd("/Users/brunykrijgsman/Documents/Documenten - MacBook Air van Bruny/Master PSY/Programming the Next Step/MathQuest")
